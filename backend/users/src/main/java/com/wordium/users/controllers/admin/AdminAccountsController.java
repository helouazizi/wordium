...
public class AdminAccountsController {
    ...
    @Operation(
            ...
            description = "Retrieve a list of all user accounts. Supports optional filtering by active/banned status (currently disabled in code)."
    )
    @ApiResponses({
    ...
    @Operation(
            summary = "Ban a user",
            description = "Ban a user account by ID. Sets the banned flag to true."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Remove ban from a user account by ID. Sets the banned flag to false."
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Update the role of a user (e.g., USER → MODERATOR → ADMIN). Requires a JSON body with the new role."
    )
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "Unauthorized",
                    content = @Content(schema = @Schema(implementation = ProblemDetail.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden - Not an admin or insufficient privileges",
                    content = @Content(schema = @Schema(implementation = ProblemDetail.class))),
            @ApiResponse(responseCode = "500", description = "Internal Server Error",
                    content = @Content(schema = @Schema(implementation = ProblemDetail.class)))
    })
    ...
    @Operation(
            ...
            description = "Permanently delete a user account by ID. Use with caution."
    )
    @ApiResponses({
